...
; The (not lyr) excludes the current lyr and the next layer is selected
(setq lyrlst nil)
...
(foreach lyr lyrlst
  (progn
    ...
    (if (> (sslength ss) 0)
      (progn
        ;switch layer on, thaw and unlock to export and see something when loaded
	      (command "-layer" "_on" lyr "_thaw" lyr "_unlock" lyr "")
        ;concatenate current path, filename, "_", layername and extension

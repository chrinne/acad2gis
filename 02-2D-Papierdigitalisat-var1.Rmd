...
Der dann vorliegende saubere Datenbestand kann an die Tabelle polyg_layer_2d angefügt werden.

```
Insert into polyg_layer_2d (filename, layer, geometry)
select filename, layer, geom from tmp_polygonize_single;
```

Wenn gewünscht noch die verarbeitetn Linien der aus line_layer_2d löschen.

...
|----:|----|----:|----:|----::|----:|----:|----:|
| 348 | Befunde | 0.112000 | 26.366780 | 51.888000 | 52.000000 | 14 | 2.953079 |
| 380 | Befunde | 1.411000 | 21.489896 | 51.890000 | 53.301000 | 114 | 30.322244 |
| 379 | Befunde | 1.381000 | 3.940367 | 51.920000 | 53.301000 | 25 | 5.441646 |
| 378 | Befunde | 1.361000 | 2.719274 | 51.940000 | 53.301000 | 16 | 3.700932 |
| 376 | Befunde | 1.369000 | 1.711535 | 51.940000 | 53.309000 | 15 | 2.343091 |
| 377 | Befunde | 1.350000 | 0.882061 | 51.960000 | 53.310000 | 10 | 1.190782 |
| 317 | Befunde | 51.670000 | 0.422846 | 0.140000 | 51.810000 | 77 | 21.848455 |
| 294 | Befunde | 51.571000 | 0.159236 | 0.140000 | 51.711000 | 27 | 8.211957 |
| 326 | Befunde | 51.742000 | 0.102362 | 0.140000 | 51.882000 | 20 | 5.296406 |
| 425 | Befunde | 51.567389 | 0.076708 | 0.140000 | 51.707389 | 16 | 3.955609 |
| 424 | Befunde | 51.201440 | 0.072005 | 0.140000 | 51.341440 | 13 | 3.686785 |
| 476 | Befunde | 51.227000 | 0.056821 | 0.140000 | 51.367000 | 16 | 2.910747 |
...
Union all
Select 'line', IsValid(Geometry), count(*) from line_layer_3d group by IsValid(Geometry)
Union all
Select 'point', IsValid(Geometry), count(*) from point_layer_3d group by IsValid(Geometry)
Union all
Select 'polyg', IsValid(Geometry), count(*) from polyg_layer_3d group by IsValid(Geometry)
Union all
Select 'text', IsValid(Geometry), count(*) from text_layer_3d group by IsValid(Geometry);
Commit;
```
